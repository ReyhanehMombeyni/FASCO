...
export const Footer = () => {
  ...
  return (
    <footer className="px-10 md:px-20 lg:px-30">
      <div className="w-full bg-white py-8 lg:pt-20 lg:pb-12 flex items-center justify-between gap-5">
          ...
          <div className="mx-auto text-center">
            <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-serif font-medium text-gray-800 mb-6 tracking-wider">
              Subscribe To Our Newsletter
            </h2>
            <p className="text-xs lg:text-sm text-gray-600 mb-8 max-w-lg mx-auto">
      ...
      <div className="w-full bg-white border-t border-gray-100">
        <div className="mx-auto py-4 gap-4 flex flex-col items-start md:flex-row md:items-center justify-between">
          ...
          <nav className="flex md:justify-end space-x-4 lg:space-x-8 text-gray-600">
